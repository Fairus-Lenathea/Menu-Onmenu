// ===== DATA PRODUK KOPI KILO (STRUKTUR BARU) =====
const products = [
  {
    name: 'Pir Xianglie',
...
if (isCheckout) {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('order-id').textContent = 'KK' + Date.now().toString().slice(-8);
  ...
  function processOrder() {
    ...
    const waNumber = '6285176773633'; // Nomor WA Kopi Kilo
